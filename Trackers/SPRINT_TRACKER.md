...
| 5 | State-focus 3-leg chain | ⏳ Planned | Leg manager service, breathwork completion handlers, silent-timer page for reflection (`content_id == null`), skip leg UX. Depends on T1 only. |
| 6 | Polish + edge cases | ⏳ Planned | Multi-phase completion summary, skip/shorten phase UX, recency warning surfacing, breathwork `duration_minutes` cap (Anomaly #11), yoga swap-from-engine. Depends on T1–T5 all landing. |
