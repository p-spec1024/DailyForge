...
| 4 | User level tracking — per-pillar level columns + history-based inference | ⏳ Next | Promotes FUTURE_SCOPE #34 from future scope to launch-blocking. Required input for the suggestion engine. Final Sprint 11 ticket. |
