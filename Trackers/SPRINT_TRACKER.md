...
**Progress:** T1 ✅ → T2 ✅ → T3 ✅ → T3.5 ✅ → T4 ✅ → T5 ✅ → **T6 ⏳ (next, branches off `s12-t5`)** → T7.
...
| 6 | Swap-counter + exclusion endpoints | ⏳ Pending | Extends swap handler to increment `exercise_swap_counts`. Adds `/api/exercises/:id/exclude` and `/keep-suggesting`. Will branch from `s12-t5`. |
