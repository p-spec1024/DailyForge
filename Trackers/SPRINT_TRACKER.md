...
| 4 | Player embedding refactor | ⏳ Planned | Strength/yoga/breathwork pages gain embedded mode for orchestrator hosting. Cross-pillar end-to-end with real players after this. Depends on T1 + T2 + T3. |
