...
| 4 | Resume Logic Fix | main | ✅ Shipped | Apr 13 | Apr 13 | startSession accepts opts.type ('5phase' vs 'strength'), handleResume routes by session.type: restores strengthOnly for strength sessions, navigates to /?mode=empty for empty workouts. 3-line core fix. Review: A. |
